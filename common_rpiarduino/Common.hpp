...
enum class State { Ready, Stabilize, ReturnHome, GetToCalibratePos, Calibrate, TakingTree, Swinging, JustGonnaSendIt, JustGonnaSmoothIt, BuildUp, Drop, ShortCircuitForward, ShortCircuitBackward, Error };

constexpr double startPos = 0.0;
constexpr double wheelRadius = 0.0505; // m
